...
class SearchController extends Controller {
    public static function products(Request $request) {
        ...
        $products = Products::select('mother_cat_1')
            ->where('shop', 1)
            ->get();
    ...
    public static function animals(Request $request){

        return view('animals');

    }

    public static function animalsPost(Request $request){
    ...
    public static function glass(Request $request){
